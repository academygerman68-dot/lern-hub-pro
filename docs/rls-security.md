...
| Table                         | SELECT                                                                                      | WRITE                                 |
| ----------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------- |
| profiles                      | self, admin, assigned teacher (student profiles), enrolled student (class teacher profiles) | self (non-privileged fields) or admin |
...
| student_subscriptions         | own, assigned teacher, or admin                                                             | admin                                 |
| invoices / student_payments   | own or admin                                                                                | admin                                 |
