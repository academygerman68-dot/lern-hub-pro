-- Restore catalogue monthly MAD to 1200 (prod métier) after erroneous 1000 overwrite.
-- Preserve acquired open échéances amounts; server quotes use stored amount when present.
-- Reporting FX stays 1 EUR = 10 MAD. EUR catalogue left at 100 (unchanged from prior prod).
