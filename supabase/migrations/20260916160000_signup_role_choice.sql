-- Allow signup metadata to choose student | teacher | admin.
-- Note: open admin self-signup is intentional for academy bootstrap; tighten later with invite codes.
...
BEGIN
  ...
  IF requested_role IN ('student', 'teacher', 'admin') THEN
